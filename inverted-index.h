...
/**
 * Frees all dynamic memory associated with the given index. Note that the
...
/**
 * Queries the inverted index. This returns a set containing the names of files
 * that contain the given token.
 */
Set *query(Index *, char *);
